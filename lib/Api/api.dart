...
Future<String> api_Add(String tendiadanh, String nhucau, String vungmien, String noidung, String hinhanh, String kinhdo, String vido) async {
  String result = "";
  String url =
      urlBaseAPI + "ThemDiaDanh?tendiadanh=$tendiadanh&nhucau=$nhucau&vungmien=$vungmien&noidung=$noidung&hinhanh=$hinhanh&kinhdo=$kinhdo&vido=$vido";
  final response = await http.post(Uri.parse(urlBaseAPI +
      "ThemDiaDanh?tendiadanh=$tendiadanh&nhucau=$nhucau&vungmien=$vungmien&noidung=$noidung&hinhanh=$hinhanh&kinhdo=$kinhdo&vido=$vido"));
  result = response.body;
  return result;
}
